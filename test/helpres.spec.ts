...
import { encodeParams } from '../src/fetch-rails';
...
describe('helpers', function() {
  describe('#encodeParams(params)', function() {
    ...
    it('encode array of objects in uri params', function() {
      ...
      assert.equal(
        'users%5B0%5D%5Bname%5D=Jhon&users%5B0%5D%5Bage%5D=20&users%5B1%5D%5Bname%5D=Jhon2&users%5B1%5D%5Bage%5D=25',
        result,
      );
    });
  });
